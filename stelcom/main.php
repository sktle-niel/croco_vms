...
// Allowed pages
$allowed_pages = ['dashboard', 'votersAccount', 'finalVotes', 'result', 'manage', 'account'];

if (!in_array($page, $allowed_pages)) {
    $page = 'dashboard';
}

// Include session and backend functions
...
<body class="admin-body">
    ...
    <script>
        ...
        function updateSidebarLogo(theme) {
            ...
            if (logo) {
                logo.src = theme === 'dark' ? '../../assets/img/ic2-namberwan.png' : '../../assets/img/ic2-nambertwo.png';
            }
        }
    </script>
